...
const SpotifyConnect: React.FC = () => {
    ...
    return (
        <div className="bg-gray-800 p-4 rounded-xl shadow-2xl animate-fade-in">
            ...
            <div className="bg-gray-700/50 rounded-lg p-6 flex flex-col items-center justify-center text-center">
                <SpotifyIcon className="h-16 w-16 text-green-500 mb-4" />
                {isConnected ? (
                     <div className="text-center">
                        <div className="flex items-center justify-center bg-green-500/20 text-green-300 font-semibold px-4 py-2 rounded-lg">
                    ...
                    <>
                        ...
                        <button
                            ...
                            className="flex items-center justify-center bg-green-500 hover:bg-green-600 disabled:bg-green-800 disabled:cursor-wait text-white font-bold py-2 px-6 rounded-full transition-all duration-300 shadow-lg"
                        >
